...
public class deviceResponse implements KvmSerializable {
    
    public deviceTO device;
    public String message;
    public int returnCodeField;
    
    public deviceResponse(){}
    
    public deviceResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("device"))
        {
            SoapObject j = (SoapObject)soapObject.getProperty("device");
            device =  new deviceTO (j);
