...
public class VectorcategoryTO extends Vector<categoryTO> implements KvmSerializable {
    
    
    public VectorcategoryTO(){}
    
    public VectorcategoryTO(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    categoryTO j1= new categoryTO(j0);
                    add(j1);
                }
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "categoryTO";
        info.type = categoryTO.class;
    }
